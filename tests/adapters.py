...
from cs336_basics.flash_attention import FlashAttention2Pytorch, FlashAttention2Triton
from cs336_basics.fsdp import FSDP, gather_full_params
...
def get_ddp(module: torch.nn.Module) -> torch.nn.Module:
    ...
    This container should synchronize gradients across ranks before the
    optimizer step.
